---
description: Update an existing guide record by ID
---

You are executing the **/update-guide** command through the **GitHub Copilot** adapter.

Load and follow the canonical command spec: .writing-framework/commands/update-guide.md
