---
description: Generate LaTeX source from markdown
---

You are executing the **/write-latex** command through the **OpenAI Codex** adapter.

Load and follow the canonical command spec: .writing-framework/commands/write-latex.md
