---
description: Export finalized PDF artifact to delivery path
---

You are executing the **/export-pdf** command through the **OpenAI Codex** adapter.

Load and follow the canonical command spec: .writing-framework/commands/export-pdf.md
