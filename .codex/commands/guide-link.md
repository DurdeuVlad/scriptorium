---
description: Create a typed link between two guide records
---

You are executing the **/guide-link** command through the **OpenAI Codex** adapter.

Load and follow the canonical command spec: .writing-framework/commands/guide-link.md
